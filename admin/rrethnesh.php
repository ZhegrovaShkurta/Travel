...
<a class="active" href="rethnesh.php">Rreth Nesh</a>
...
<form action="" method="post">
            ...
            <br><a id="submit2" href="addrrethnesh.php">Shto te Dhena</a><br><br>
...
<?php
	...
	$sql = mysqli_query($conn,"SELECT * FROM rrethnesh WHERE Titulli LIKE '%".$term."%' OR Pershkrimi LIKE '%".$term."%'  OR EmrF0 LIKE '%".$term."%'");  
	while($row = mysqli_fetch_array($sql)) { 		
			...
			echo "<td><button id='submit2'> <a style='color:white;' href=\"editrrethnesh.php?ID_RrethNesh=$row[ID_RrethNesh]\"><center>Ndrysho</a></button> <br> <button id='submit2'> <a style='color:white;' href=\"deleterrethnesh.php?ID_RrethNesh=$row[ID_RrethNesh]\" onClick=\"return confirm('Je i sigurte qe doni ta fshini?')\">Fshij</center></a></button></td>";
			echo "</tr>";
		}
