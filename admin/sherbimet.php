...
<form action="" method="post">
            ...
            <br><a id="submit2" href="addsherbimet.php">Shto te Dhena</a><br><br>
...
<?php
	...
	$sql = mysqli_query($conn,"SELECT * FROM sherbimet WHERE Titulli LIKE '%".$term."%' OR Pershkrimi LIKE '%".$term."%'  OR EmrF0 LIKE '%".$term."%'");  
	while($row = mysqli_fetch_array($sql)) { 		
			...
			echo "<td><button id='submit2'> <a style='color:white;' href=\"editsherbimet.php?ID_Sherbimi=$row[ID_Sherbimi]\"><center>Ndrysho</a></button> <br> <button id='submit2'> <a style='color:white;' href=\"deletesherbimet.php?ID_Sherbimi=$row[ID_Sherbimi]\" onClick=\"return confirm('Je i sigurte qe doni ta fshini?')\">Fshij</center></a></button></td>";
			echo "</tr>";
		}
