...
<a class="active" style="opacity: 50%;" href="loginF.php">Login</a>
    ...
    <div id="content" >
    <?php
$result = mysqli_query($conn, "CALL SelectFromRrethNesh()");
...
?>
        <table class="table1">
            <tr>
                <td><h2><?php echo $Titulli; ?></h2>
                    &nbsp; &nbsp; <?php echo $Pershkrimi; ?></td>
                <td><?php 
 mysqli_next_result($conn);
        if($Image==null){
                                ...
                                echo '<img style="border-radius: 50px; border: 3px solid #008080;" alt="" src="data:img/jpeg;base64,'.base64_encode( $row['Image'] ).'" width="100%""/>';}
